...
private val creamLightScheme = lightColorScheme(
    ...
    surfaceVariant = Color(0xFFE5E1D4),
    onSurfaceVariant = Color(0xFF8F8B7E),
    outline = Color(0xFFA6A296),
    outlineVariant = Color(0xFFE1DDD0),
    surfaceDim = Color(0xFFE3DECF),
    surfaceBright = Color(0xFFF5F3EC),
    surfaceContainerLowest = Color(0xFFFFFFFF),
    surfaceContainerLow = Color(0xFFF5F3EC),
    surfaceContainer = Color(0xFFECE8DC),
    surfaceContainerHigh = Color(0xFFE5E1D4),
    surfaceContainerHighest = Color(0xFFDED9CA),
    inverseSurface = Color(0xFF2A2822),
    inverseOnSurface = Color(0xFFF0EEE6),
