package funapp.ctrlcv.zhiyu.core.data.testing

import android.content.SharedPreferences

/** In-memory Android persistence boundary; production UsageCache still serializes all data. */
internal class MemoryPreferences : SharedPreferences {
    ...
    private inner class Editor : SharedPreferences.Editor {
        ...
        override fun remove(key: String?) = apply { changes[requireNotNull(key)] = null }
